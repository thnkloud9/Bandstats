...
./import_bands_from_url.js -u "http://www.thedelimagazine.com/bandstats/api/bands_export.php?limit=5000&maxId=20000" update
./import_bands_from_url.js -u "http://www.thedelimagazine.com/bandstats/api/bands_export.php?limit=5000&maxId=25000" update
./import_bands_from_url.js -u "http://www.thedelimagazine.com/bandstats/api/bands_export.php?limit=5000&maxId=30000" update
